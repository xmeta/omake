...
% Identifiers.
%
\newcommand\var[1]{\index{#1}\index[var]{#1}\label{var:#1}\subsubsection{#1}}
\newcommand\varlabel[2]{\index{#2}\index[var]{#2}\label{var:#1}\subsubsection{#2}}
\newcommand\funref[1]{\index{#1}\index[fun]{#1}\label{fun:#1}}
\newcommand\fun[1]{\funref{#1}\subsubsection{#1}}
\newcommand\form[1]{\par\index{#1}\index[fun]{#1}\label{fun:#1}\subsubsection{#1}}
\newcommand\objref[1]{\index{#1}\index[obj]{#1}\label{obj:#1}}
\newcommand\obj[1]{\objref{#1}\subsubsection{#1}}
\newcommand\targetref[1]{\index{#1}\index[target]{#1}\label{target:#1}}
\newcommand\target[1]{\targetref{#1}\subsubsection{#1}}
...
\newcommand\heading{%
\ahref{http://omake.metaprl.org/}{OMake Home}
\ahref{index.html}{Table of contents}
\ahref{omake-index.html}{Guide}
\ahref{omake-options.html}{Options}
\ahref{omake-all-index.html}{Index}
\ahref{omake-var-index.html}{Variables}
\ahref{omake-fun-index.html}{Functions}
\ahref{omake-obj-index.html}{Objects}
\ahref{omake-target-index.html}{Targets}
}
\htmlhead{\heading}
\htmlfoot{\heading}
