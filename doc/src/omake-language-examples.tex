...
A \verb+String+ is a single value; whitespace is significant in a string.  Strings are introduced
...
always expanded within a quote of this kind.  Note that the \Cmd{osh}{1}~\ref{chapter:osh} printer
