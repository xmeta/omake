...
%define index         %(echo $RELEASE)

Summary: The omake build system.
Name: omake
Version: %(echo $VERSION)
Release: %{index}%{?distro_release:.%{distro_release}}
...
%files
%defattr(-,root,root)
%doc LICENSE doc/txt/omake-doc.txt doc/ps/omake-doc.ps doc/ps/omake-doc.pdf doc/html CHANGELOG.txt README.ocamldep-omake
...
- Updated to accound for the new non-autoconf build style.
